...
CORS_ALLOWED_ORIGINS = ['https://frontend-five-kohl.vercel.app',
                        'http://localhost:3000',
                        'http://127.0.0.1:3000'
                        ]
...
# PROJ_LIBRARY_PATH = VIRTUAL_ENV_BASE+'/Lib/site-packages/osgeo/data/proj'
# GDAL_DATA = VIRTUAL_ENV_BASE+'/Lib/site-packages/osgeo/data/gdal'
